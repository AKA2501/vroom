...
#include <iostream>
#include "/home/ani/rapidjson/include/rapidjson/document.h"
#include "/home/ani/rapidjson/include/rapidjson/writer.h"
#include "/home/ani/rapidjson/include/rapidjson/stringbuffer.h"
...
void OsrmRoutedWrapper::check_response(const rapidjson::Document& json_result,
  ...
  if (code != "Ok") {
    ...
    if (const std::string snapping_error_base =
      ...
      std::cout << "Specific error: Could not find route near location " << coordinates << std::endl;
